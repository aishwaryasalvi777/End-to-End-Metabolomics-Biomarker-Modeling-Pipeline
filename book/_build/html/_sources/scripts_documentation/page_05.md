...
1. Loads PCA score tables from Script 04 outputs.
2. Applies outlier detection logic on PCA coordinates.
3. Flags outliers for placenta, cord, and combined datasets.
4. Exports full outlier-flag tables and outlier-only tables.
5. Produces a combined PCA table with outliers removed for downstream analysis.
