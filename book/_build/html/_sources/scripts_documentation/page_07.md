...
1. Loads outlier flags and PCA/loading inputs from prior steps.
2. Computes top metabolite loadings for PC1 and PC2.
3. Quantifies metabolite contributions for detected outlier samples.
4. Builds recurrent driver summaries across placenta, cord, and combined datasets.
5. Exports detailed contribution/loadings tables and summary findings for interpretation.
